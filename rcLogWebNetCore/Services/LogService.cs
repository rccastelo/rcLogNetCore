...
namespace rcLogWebNetCore.Services
{
    public class LogService
    {
        // private string enderecoServico = Settings.GetSetting("rcLogApiEndereco");
        ...
        // public async Task<LogTransfer> Listar(LogTransfer pLogLista, string pAutorizacao)
        // {
